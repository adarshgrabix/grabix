...
<nav class="navbar navbar-custom no-border  nodown-margin" role="navigation">
	 ...
	 <br>
	 <center>
      <span   style="color:white; letter-spacing: 2px; font-weight: 600; font-size:16px; font-family:arial;"><b>Update Your Password Here</b></span>
	       </center>
	   <hr>
...
<div class="panel panel-default no-border">
  ...
  <span   style="color: #cb202d; letter-spacing: 2px; font-weight: 600; font-size:17px; font-family:arial;"><b>Update New Password</b></span>
        ...
        @endforeach
			  ...
			  @endif
			 <center>
				 <form  method="POST" action="/otpprocess">
				{{ csrf_field() }}
					...
					<label>OTP</label>
					<input type="integer" name="otp" placeholder="OTP">
					...
					Want to register ?<a href="/login" class="pass">Sign Up Here</a>
				</form>
