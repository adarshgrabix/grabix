...
<nav class="navbar navbar-custom no-border  nodown-margin" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><p style="font-family:verdana;font-size:18px">Grabix</p></a>
            </div>
	 ...
	 <br>
	 <center><div style="height:60px;padding-top:15px;padding-bottom:15px; background-color: #333;">
      <span   style="color:white; letter-spacing: 2px; font-weight: 600; font-size:16px; font-family:arial;"><b>JOIN INDIA'S FASTEST GROWING CASHBACK PLATFORM</b></span>
	       </div></center>
	   <hr>
...
<div class="panel panel-default no-border">
  ...
  <span   style="color: #cb202d; letter-spacing: 2px; font-weight: 600; font-size:17px; font-family:arial;"><b>Sign Up Here</b></span>
               
			<ul>
        @foreach( $errors->all() as $message )
          <li><font face="arial" size="2" color="#CB202D"><strong>{{ $message }}</strong></font></li>
        @endforeach
             </ul><center>
				...
				{{ csrf_field() }}
					...
					<label>Mobile</label>
					<input type="integer" name="mobile" placeholder="Mobile" >
					...
					By signing up, you agree to<a href="#" class="pass"> Terms & Conditions</a>
					<input type="submit" value="Sign up" />
					Already registered ?<a href="/login" class="pass"> Login Here</a>
				</form>
