...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="/reg_css/font-awesome.css">
...
<nav class="navbar navbar-custom no-border  nodown-margin" role="navigation">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!-- account profile -->
                     ...
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            							<center><font face="arial" size="2" color="black"><strong>Hii,adarsh kumar</strong></font> 
							<br><font face="arial" size="1" color="black"><strong>adarshsinghiiit@gmail.com</strong></font></center>
                                   <hr>
							<li>
   	...
   	<center> 
    <div class="jumbotron " style="padding-top:30px;padding-bottom:16px;">
       <div class="row">
	   <center>
    ...
    <span   style="color:black; letter-spacing: 2px; font-weight: 600; font-size:17px; font-family:calibri;"><b>Select Preference</b></span>
			...
			<center>
				<form  method="POST" action="/check">
					...
					<label>Email</label>
					<input type="email" name="email" placeholder="Your Budget">
	   ...
	   <div class="col-md-3">
	      <div class="panel panel-default no-border">
    <div class="panel-body">
    <span   style="color: #cb202d; letter-spacing: 2px; font-weight: 600; font-size:17px; font-family:arial;"><b>Login Here</b></span>
...
<div class="panel panel-default">
  <div class="panel-body">
   ...
   <br>
    <p style="font-family:arial;font-size:16px;text-align:justify"> Founded in 2016.Grabix is an online venture of Grabix Web Services lists best offers,deals,promos & coupons on our website of multiple online stores & services like Flipkart, Amazon, mobikwik,ebay,jabong,PayTM and myntra. 
	We provides you various choices for easy ,simplified and smart shopping.</p>
	
	<br>
 <p style="font-family:Verdana;font-size:18px;font-color:#33373D"><strong>We Work,Research and Simplified Your Online Shopping </strong></p>

	<p style="font-family:arial;font-size:16px;text-align:justify"> We put right things on our site accourding to users demand.If you are looking for best offers & coupons 
	then it is the right place that provides you whole range of offers,discounted products.
	We have partnerships with <strong>150+ online stores & services</strong>  to provide best offers and deals in almost all categories.<br>
	
 <p style="font-family:Verdana;font-size:15px;font-color:#33373D"> <strong>Let Us Know why Grabix.in </strong></p> <br>
	
	 <ul>
<li>Fascinating user-experience   </li>
<li>One click coupon,offer access</li>
<li>Does not charge any redemption fee</li>
<li>No signup or Registration required</li>
<li>Daily updated exiciting offers,deals and coupons                                  </li>
	...
	<br>
	 <p style="font-family:Verdana;font-size:18px;font-color:#33373D"> <strong>Save With Us</strong></p>
	<p style="font-family:Verdana;font-size:15px;font-color:#33373D"> <strong>We do this by </strong></p> 

	<ul>
	<li>Helping people discover great deals,offers and coupons online.</li>
    <li>Building amazing User Experiences</li>	
     <li>Regular updates on social media platforms</li>
	
	
	</ul>
	<br>
	
	<p style="font-family:Verdana;font-size:15px;font-color:#33373D"><strong>Hence it is really an awesome platform</strong></p>
	<hr>
	<p style="font-family:Verdana;font-size:15px;font-color:#33373D"><strong>For any query contact us through support@grabix.in</strong></p>
