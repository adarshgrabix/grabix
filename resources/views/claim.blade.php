...
<html lang="en">
  <head>
   ...
   <title>Claim Voucher</title>
    ...
    <meta name="description" content="Grabix:Contact Us">
    <meta name="keywords" content="Grabix support,support@grabix.in,Grabix contact">
...
<nav class="navbar navbar-custom no-border nodown-margin" role="navigation">
  	...
  	<center> <img height="50px" src="/images/voucher.png" class="img-responsive" alt="Responsive image"> </center>
	
	 <div class="container" role="main">
	 <br>
	 <br><center>
	    <span   style="color:#33373D; letter-spacing: 2px; font-weight: 600; font-size:23px; font-family:arial;"><strong>Book tickets with us and get assured shopping voucher</strong></span></center>
...
<br>
	...
	<center>
  <div class="col-md-6">
  <center><p style="font-family:arial;font-size:18px">Just fill your product details</p>
<div  class="panel panel-default">
 ...
 <form class="form-horizontal" method="POST" action="http://formspree.io/youngersera@gmail.com">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input name="contact" type="text" class="form-control" id="inputPassword3" placeholder="Contact Number">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-8">
      <input name="contact" type="text" class="form-control" id="inputPassword3" placeholder="Movie,Event Name">
    </div>
  </div>
  ...
  <br>
   ...
   <div class="col-md-6">
  <center><p style="font-family:arial;font-size:18px">Important Information</p>
   <div  class="panel panel-default">
  <div class="panel-body">
  ...
  <div class="col-md-12">
 <p style="font-family:calibri;font-size:15px;text-align:justify"><b>1-Book tickets on ticketnew via grabix and get assured shopping voucher which can be used on respective online stores.</b></p>
  <p style="font-family:calibri;font-size:15px;text-align:justify"><b>2-User will be eligible for shopping voucher if he/she book ticket via grabix.in.</b></p>
    <p style="font-family:calibri;font-size:15px;text-align:justify"><b>3-User will get shopping voucher within 48 hours after confirmation of product on their email id</b></p>
	 <p style="font-family:calibri;font-size:15px;text-align:justify"><b>4-In case of fraud detection grabix.in have full right to ban user from loyality program.</b></p>
    <p style="font-family:calibri;font-size:15px;text-align:justify"><b>5-Provided vouchers is not the property of grabix.in</b></p>
	<p style="font-family:calibri;font-size:15px;text-align:justify"><b>6-In case of any issue drop a mail at support@grabix.in</b></p>
  </div>
  </center>
  </div>
  ...
  <center> <span style="color:#33373D; letter-spacing: 2px; font-weight: 600; font-size:21px; font-family:arial;"><b>Claim your gift</b></span>
  <br><p style="font-family:calibri;font-size:20px;text-align:center">
 <strong> Get assured shopping voucher on every ticketnew booking via grabix</strong>
 <br><p style="font-family:calibri;font-size:20px;text-align:center"> <strong># Save With Us</strong></p>
  </p>
<img class="img-responsive" src="/images/ticket.png"></img>
  </center>
