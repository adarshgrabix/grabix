...
<nav class="navbar navbar-custom no-border  nodown-margin" role="navigation">
	 ...
	 <br>
	 <center>
      <span   style="color:#33373D; letter-spacing: 2px; font-weight: 600; font-size:18px; font-family:arial;"><b>Sign in or you miss your cashback</b></span>
	       </center>
	   <hr>
        ...
        @endforeach
			...
			<center>
				...
				{{ csrf_field() }}
					...
					<a href="/resetform" class="pass"> Forgot Password ?</a>
					<input type="submit" value="Login" />
					Not registered ?<a href="/register" class="pass"> Sign Up Here</a>
				</form>
