...
<html lang="en">
  <head>
       ...
       <title>Password Reset | Grabix</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-custom no-border  nodown-margin" role="navigation">
	 ...
	 <br>
	 <center>
      <span   style="color:#33373D; letter-spacing: 2px; font-weight: 600; font-size:18px; font-family:arial;"><b>Reset Your Password</b></span>
	       </center>
	   <hr>
...
<div class="panel panel-default no-border">
  ...
  <span   style="color: black; letter-spacing: 1px; font-weight: 600; font-size:14px; font-family:arial;">Enter Your Email.We will send 5 digit OTP on your mobile associated with this Grabix account</span>
             <ul>
        @foreach( $errors->all() as $message )
          <li><div style="height:30px;padding-top:5px;padding-bottom:5px; background-color:lightblue;"> 
		  <span   style=" letter-spacing: 1px; font-size:16px; font-family:arial;">{{ $message }}</span></div></li>
        @endforeach
             </ul>  
			<center>
				<form  method="POST" action="/resetprocess">
				{{ csrf_field() }}
