...
<nav class="navbar navbar-custom no-border" role="navigation">
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#"><b>Popular Stores </b><b class="caret"></b></a>
                     <ul role="menu" class="dropdown-menu">
                       ...
                       <li><a href="\bigrock">Bigrock</a></li>
                        <li><a href="\tatacliq">TataCliq</a></li>
                         <li><a href="\industrybuying">TataCliq</a></li>
                    </ul>
                </li>
 ...
 <center><img class="img-responsive"  src="images/hotdeals.jpg"</center>
...
<div class="myborder"></div>   
 ...
 @foreach ($testbox as $test)
 <br>
 {{$test->Title}} <strong> {{$test->Merchant}} </strong>
 <br>
 ...
 <div class="row"><center>
  ...
  <div class="col-md-12"><h3 style="color:#cd3232; letter-spacing: 2px; font-weight: 600; font-size:22px; font-family:arial;"><b>Fastest Growing Coupons & Deals Plateform</b></h3>

  <br>
   <p style="font-family: 'Crimson Text', serif; font-size:16px;color:black;text-align:justify;">
...
<br> </div>
  ...
  <br>
   ...
   <a href="\aboutus"><font face="Verdana" size="2" color="grey"><b> About Us</b></font>  </a> 
	<br>
	<a href="\team.php"><font face="Verdana" size="2" color="grey"><b>Meet the Team</b></font> </a>
	<br>
