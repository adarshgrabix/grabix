...
<html lang="en">
  <head>
   ...
   <title>Contact Us</title>
    ...
    <meta name="keywords" content="Grabix support,suppoer@grabix.in,Grabix contact">
...
<nav class="navbar navbar-custom no-border nodown-margin" role="navigation">
  	...
  	<center> <img height="50px" src="/images/cbg.jpg" class="img-responsive" alt="Responsive image"> </center>
	
	 <div class="container" role="main">
	 <br>
	 <br><center>
	    <span   style="color:#33373D; letter-spacing: 2px; font-weight: 600; font-size:23px; font-family:arial;"><strong>Feel free to Contact Us.We always ready for you</strong></span></center>
...
<div  class="panel panel-default">
  <div class="panel-body">
	...
	<center>
  <div class="col-md-6">
  <center><p style="font-family:arial;font-size:18px">Send Us Your Query</p>
<div  class="panel panel-default">
  <div class="panel-body">
 <form class="form-horizontal" method="POST" action="http://formspree.io/youngersera@gmail.com">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input name="contact" type="number" class="form-control" id="inputPassword3" placeholder="Contact Number">
    </div>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="col-md-6">
  <center><p style="font-family:arial;font-size:18px">Get in touch with us</p>
   <div  class="panel panel-default">
  <div class="panel-body">
  ...
  <div class="col-md-4">
   ...
   <img height="80px" width="80px" src="/images/query.png" class="img-responsive img-circle" alt="Responsive image">
  </div>
  
  <div class="col-md-8">
  <p style="font-family:arial;font-size:16px"><strong>General Issues</strong> <br> Email:support@grabix.in</p>
  </div>
  </center>
  </div>
	<br>
  ...
  <div class="col-md-4">
   ...
   <img height="80px" width="80px" src="/images/businessi.png" class="img-responsive img-circle" alt="Responsive image">
  </div>
  
  <div class="col-md-8">
  <p style="font-family:arial;font-size:16px"><strong>Marketing & Business</strong> <br> Email:youngersera@gmail.com</p>
  </div>
  </center>
  </div>
  <br>
  ...
  <div class="col-md-4">
   ...
   <img height="80px" width="80px" src="/images/joini.png" class="img-responsive img-circle" alt="Responsive image">
  </div>
  
  <div class="col-md-8">
  <p style="font-family:arial;font-size:16px"><strong>Operation</strong> <br> Email:anandsingh@grabix.in</p>
  </div>
  </center>
  </div>
 ...
 <br>
  ...
  <center> <span style="color:#33373D; letter-spacing: 2px; font-weight: 600; font-size:21px; font-family:arial;"><b>Be part of our journey</b></span>
  <br><p style="font-family:calibri;font-size:15px;text-align:justify">
