        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="/otpprocess">
                        {{ csrf_field() }}
						  ...
						  <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="integer" class="form-control" name="mobile"  required>
						  ...
						  <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="integer" class="form-control" name="otp"  required>
                            ...
                            <div class="col-md-6">
                                <input id="email" type="password" class="form-control" name="newpassword"  required>
